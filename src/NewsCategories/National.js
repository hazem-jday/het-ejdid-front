            ...
            <div className='row col-lg-12' dir="rtl">
                ...
                <nav className="row " dir="ltr" aria-label="Page navigation example">
                    <ul className="pagination justify-content-center">
                        ...
                        <li className={`page-item ${n===pagination[1] ? "active":""}`}><a className="page-link" href={"/Nat/"+pagination[1]}>{pagination[1]}</a></li>
                        <li className={`page-item ${n===pagination[2] ? "active":""}`}><a className="page-link" href={"/Nat/"+pagination[2]}>{pagination[2]}</a></li>
                        <li className="page-item"><a className="page-link" href={"/Nat/"+pagination[3]}>{pagination[3]}</a></li>
