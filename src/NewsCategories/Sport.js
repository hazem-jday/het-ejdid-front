        ...
        <div className="container row justify-content-center" dir="rtl" style={{}}>
            <div className='row col-lg-12' dir="rtl">
                ...
                <div className="col-lg-12">
                    <h4 className="text-light text-center"><Badge bg="primary">أخبار الرياضة</Badge></h4>
                </div>
                ...
                <nav className="row " dir="ltr" aria-label="Page navigation example">
                    <ul className="pagination justify-content-center">
                        <li className={`page-item ${n===1 ? "disabled":""}`}>
                            <a className="page-link" href={"/Sport/"+pagination[0]} tabIndex="-1">{"<"}</a>
                        </li>
                        <li className={`page-item ${n===pagination[1] ? "active":""}`}><a className="page-link" href={"/Sport/"+pagination[1]}>{pagination[1]}</a></li>
                        <li className={`page-item ${n===pagination[2] ? "active":""}`}><a className="page-link" href={"/Sport/"+pagination[2]}>{pagination[2]}</a></li>
                        <li className="page-item"><a className="page-link" href={"/Sport/"+pagination[3]}>{pagination[3]}</a></li>
                        <li className="page-item">
                            <a className="page-link" href={"/Sport/"+pagination[4]}>{">"}</a>
                        </li>
                    </ul>
                </nav>
